...
const Cart = () => {
  ...
  //create function that will handle the Pay with stripe button
  const handleCheckout = async () => {
    const stripe = await getStripe();
    
    //make api request with our NextJs backend
    ...
    await stripe.redirectToCheckout({sessionId: 'cs_test_a19ut2RIUK2NJEk5UIyvk'});
  }
  ...
  return (
    <div className='cart-wrapper' ref={cartRef}>
      <div className='cart-container'>
        ...
        {/*show empty cart icon if cart is empty*/}
        {cartItems.length < 1 && (
